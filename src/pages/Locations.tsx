  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
        {/* Current Location */}
        <div className="bg-white dark:bg-dark-800 rounded-lg shadow-md dark:shadow-none border border-gray-200 dark:border-primary-900/30 p-8 hover:shadow-xl hover:border-primary-400 dark:hover:shadow-neon transition-all duration-300 group">
        ...
        {/* New Location */}
        <div className="bg-white dark:bg-dark-800 rounded-lg shadow-md dark:shadow-none border border-gray-200 dark:border-primary-900/30 p-8 hover:shadow-xl hover:border-primary-400 dark:hover:shadow-neon transition-all duration-300 group relative overflow-hidden">
          {/* Improved ribbon that doesn't show the red end */}
      ...
      <div className="bg-gray-50 dark:bg-dark-900/50 rounded-lg p-8 border border-gray-200 dark:border-dark-700 text-center">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-primary-300 mb-4">
          Besuchen Sie uns!
        </h2>
        <p className="text-gray-600 dark:text-secondary-300 max-w-3xl mx-auto mb-6">
          Wir freuen uns auf Ihren Besuch! Vereinbaren Sie gerne vorab einen Termin, 
          damit wir uns ausreichend Zeit für Ihre Anliegen nehmen können.
        </p>
        <a 
